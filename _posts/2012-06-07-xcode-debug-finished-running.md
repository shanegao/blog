...
所以在Target->Build Settings->Architectures下的Architectures项添加arm6，Valid Architectures项目同样。。同时支持armv6，armv7。。

[armv7编译的优势](http://stackoverflow.com/questions/3310907/what-are-the-advantages-of-armv7-over-armv6-when-compiling-iphone-apps)